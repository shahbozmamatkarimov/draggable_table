<template>
  <div
    class="flex items-center h-screen space-x-6 bg-gray-300 w-56"
  >
    <!-- Component Start -->
    <div
      class="flex flex-col p-5 items-center w-56 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded"
    >
      ...
      <div class="w-full px-2">
        ...
        >
          ...
          <a
            class="flex items-center w-full h-12 px-3 mt-2 bg-indigo-700 text-indigo-100 rounded"
            href="#"
          >
            <svg
              class="w-6 h-6 stroke-current"
